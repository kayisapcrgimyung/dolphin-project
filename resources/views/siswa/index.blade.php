                        ...
                        <tbody>
                            ...
                            @foreach($siswa as $siswaItem)
                                <tr>
                                    ...
                                    <td>{{ $siswaItem->email }}</td>
                                    <td>{{ $siswaItem->no_hp }}</td>
                                    <td class="text-right">
                                        <a href="{{ url('siswa/' . $siswaItem->nisn . '/edit') }}" class="btn btn-primary btn-sm mb-1">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <form action="{{ url('siswa/' . $siswaItem->nisn) }}" method="POST" style="display: inline-block">
                                            @csrf
                                            @method('DELETE')
