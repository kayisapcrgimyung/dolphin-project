...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a class="btn btn-primary mb-3" href="{{ route('guru.create') }}">Tambah Data</a>
                        ...
                        <tbody>
                            ...
                            @foreach($guru as $guruItem)
                                <tr>
                                    ...
                                    <td>{{ $guruItem->mata_pelajaran }}</td>
                                    <td>{{ $guruItem->email }}</td>
                                    <td>{{ $guruItem->no_hp }}</td>
                                    <td class="text-right">
                                        <a href="{{ url('guru/' . $guruItem->nip . '/edit') }}" class="btn btn-primary btn-sm mb-1">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <form action="{{ url('guru/' . $guruItem->nip) }}" method="POST" style="display: inline-block">
                                            @csrf
                                            @method('DELETE')
